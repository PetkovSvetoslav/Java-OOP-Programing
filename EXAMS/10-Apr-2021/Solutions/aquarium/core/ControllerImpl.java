...
public class ControllerImpl implements Controller {
    ...
    public String addFish(String aquariumName, String fishType, String fishName, String fishSpecies, double price) {
        ...
        Aquarium aquarium = this.aquariums.get(aquariumName);
        char waterType = aquarium.getClass().getSimpleName().charAt(0);

        if (waterType != fishType.charAt(0)) {
    ...
    public String calculateValue(String aquariumName) {
        ...
        value += aquarium.getFish()
                .stream()
                .mapToDouble(Fish::getPrice)
                .sum();

        value += aquarium.getDecorations()
                .stream()
